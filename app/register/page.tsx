	...
	return (
		<section className="h-screen p-1 md:p-4 w-full">
			<section className="rounded-lg bg-gray-300/35 shadow h-full p-4 md:p-10 lg:p-20 border border-green-400/50">
				<section className="flex flex-col md:flex-row gap-2 md:gap-4 justify-center items-center h-full">
					<section className="flex flex-col bg-green-500  lg:h-full w-full md:w-2/3 lg:w-3/5 px-3 md:px-4 lg:px-8 py-10 md:py-10 lg:py-20 rounded-xl lg:justify-center order-2 md:order-1">
						<h2 className="text-center text-slate-800 text-2xl lg:text-4xl font-bold lg:mb-10 mb-4">
							Welcome to <span className="text-gray-500">Clear</span>Cargo
						</h2>
						<RegisterForm />
					</section>
					<section className="flex flex-col items-center justify-start md:justify-center md:w-2/5 md:h-full order-1 md:order-2">
						<Image
							src={
						...
						/>
						<h1 className="hidden md:block text-5xl font-bold m-0">
