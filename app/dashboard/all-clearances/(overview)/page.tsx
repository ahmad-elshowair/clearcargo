...
const page = async ({
	...
	const { data, totalPages = 1 } = await fetchFilteredClearances(
		query,
		currentPage,
	);
	...
	return (
		<section className="flex lg:min-h-screen xl:min-h-screen h-[calc(100vh-168px)] p-4 w-full flex-col gap-3">
			<h1 className="md:mb-20 md:mt-10 text-3xl font-bold">All Clearances</h1>
			...
			<Suspense fallback={<AllClearancesLoading />}>
